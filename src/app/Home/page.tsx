    ...
    <div className="w-full min-h-screen bg-[#140C1F] text-white">
      ...
      <div className="w-full max-w-[1440px] mx-auto p-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="w-full max-w-[718px] lg:mt-[147px]">
            <h1 className="lg:text-[64px] font-semibold text-3xl mb-10">
              EXPLORE, CREATE AND <br />
              SELL YOUR NFT&apos;S ON <br />
              HIHAMI
            </h1>
            <p className="font-light lg:text-[25px] text-base lg:mb-[60px] mb-10 opacity-50">
          ...
          <div className="mt-10 lg:mt-[257px] hidden lg:block">
