              ...
              >
                <ul className="space-y-2">
                  {[
                    ...
                    { label: "Trending NFTs", href: "/Trending" },
                    { label: "Auctioned NFTs", href: "/Auctioned" },
                ...
                <motion.div variants={fadeInUp} className="flex flex-col gap-2">
                  {isConnected ? (
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3"
                    ...
                    <button
                      onClick={() => setConnectOpen(true)}
                      className="w-full justify-center inline-flex items-center rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-3"
                    >
                      Connect Wallet
                    </button>
                  )}
                  <Link
                    href="/CreateNFT"
                    onClick={onClose}
                    className="w-full text-center rounded-lg border border-[#AD1AAF]/30 bg-[#AD1AAF]/20 hover:bg-[#AD1AAF]/30 px-4 py-3"
                  >
                    Create NFT
                  </Link>
                </motion.div>
